...
public class ExaminationController {
	...
	public String getPage(HttpServletRequest request, Model model,
			@ModelAttribute("anamnesisDto") AnamnesisDto anamnesisDto) {
	...
	public String getPage(HttpServletRequest request, Model model,
			@ModelAttribute("prescriptionDto") PrescriptionDto prescriptionDto) {
		Long pacientId = (Long) request.getSession().getAttribute("pacientId");
		model.addAttribute("allCodebook", codeBookService.allCodeBooks());
		model.addAttribute("prescriptionsDto", prescriptionService.getAllPrescriptionsByPacientId(pacientId));
	...
	@PostMapping("/create")
	public String finishExamination(HttpServletRequest request,
			@Valid @ModelAttribute("anamnesisDto") AnamnesisDto anamnesisDto) {
		anamnesisDto.setPacientId((Long) request.getSession().getAttribute("pacientId"));
		anamnesisService.save(anamnesisDto);
		return "redirect:/doctors/records/pacient/examination/new/appointment";
	}
...
//	@GetMapping("/calendar")
//	public String getDoctorCalendar(HttpServletRequest request, Model model,
//			@ModelAttribute("appointmentDto") AppointmentDto appointmentDto) {
//		appointmentDto.setDoctorDto((Long) request.getSession().getAttribute("logUsername"));
...
//	}
	...
	public String makeNewAppointment(Model model,HttpServletRequest request,@ModelAttribute("appointmentDto") AppointmentDto appointmentDto) {
		model.addAttribute("roomDto",new RoomDto());
		
		model.addAttribute("allRooms",roomService.getPacientsRooms((Long) request.getSession().getAttribute("pacientId")));
		return "newOperation";
	...
	public String createNewAppointment(@ModelAttribute("appointmentDto") AppointmentDto appointmentDto,HttpServletRequest request) {
		String username = (String) request.getSession().getAttribute("logUsername");
